  ...
  return `
    <div class="employee-workspace">
      ...
      <div class="panel employee-detail-panel">
        ...
        ${renderEmployeeTaskFinder(selectedPerson, selectedIndex, selectedMonth)}
...
function renderReport(report, personIndex) {
  ...
  return `
    <details class="report-card" data-report-id="${escapeAttribute(report.id)}" ${openReportIds.has(String(report.id)) ? "open" : ""}>
      <summary class="report-summary">
        <div>
          ${editableText(report.title, `report-title-id:${report.id}`, "report-title", "Название задачи")}
      ...
      <div class="report-body">
        ${isPublicView
          ...
          : `
            ...
            <textarea class="textarea report-textarea" data-change="report-field" data-live-change="report-field" data-person-id="${escapeAttribute(personId)}" data-report-id="${escapeAttribute(report.id)}" data-field="text">${escapeHtml(report.text || "")}</textarea>
...
function removeReport(personIndex, reportIndex) {
  ...
  if (removed?.id) openReportIds.delete(String(removed.id));
  touchAndRender("employees");
}
