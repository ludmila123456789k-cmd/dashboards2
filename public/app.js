    ...
    <div class="employee-tab ${isActive ? "active" : ""}" data-action="select-employee" data-employee-id="${escapeAttribute(employeeId)}">
      <div class="employee-tab-button">
        ${isPublicView
          ...
          : `<span class="employee-name-edit" contenteditable="true" data-edit="employee-name-${personIndex}" data-placeholder="Фамилия Имя">${escapeHtml(person.name || "Фамилия Имя")}</span>`}
      </div>
    </div>
  `;
}
      ...
      <div class="report-body">
        ${isPublicView
          ...
          : `
            ...
            <textarea class="textarea" data-change="report-field" data-live-change="report-field" data-person-index="${personIndex}" data-report-index="${reportIndex}" data-field="text">${escapeHtml(report.text || "")}</textarea>
