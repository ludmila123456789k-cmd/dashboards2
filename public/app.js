    ...
    <div class="employee-tab ${isActive ? "active" : ""}">
      <button class="employee-tab-button" type="button" data-action="select-employee" data-employee-id="${escapeAttribute(employeeId)}">
        ${isPublicView
          ...
          : `<span class="employee-name-edit" contenteditable="true" data-edit="employee-name-${personIndex}" data-placeholder="Фамилия">${escapeHtml(person.name || "Новая фамилия")}</span>`}
...
function bindEvents() {
  ...
  app.querySelectorAll(".employee-tab-button").forEach(button => {
