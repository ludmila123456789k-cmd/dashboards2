...
function renderEmployeeMonthlySummary(person, reports, month) {
  ...
  const visibleTopics = reportTitles.slice(0, 12);
  ...
  const topWork = workQuantities.slice(0, 5);
    ...
    <details class="monthly-summary">
      ...
      <div class="monthly-summary-body">
        ...
        <div class="monthly-section">
          <div class="monthly-section-title">Топ работ месяца</div>
          ${topWork.length
            ? `<div class="monthly-top-list">
                ${topWork.map((item, index) => `
                  <div class="monthly-top-item">
                    <span>${index + 1}</span>
            ...
            : `<div class="monthly-empty">Количество работ пока не указано в описаниях задач</div>`}
        </div>
        ...
        <div class="monthly-section">
          ...
          ${visibleTopics.length
            ? `<div class="monthly-topic-list">
                ...
                ${hiddenTopicCount ? `<span class="muted-chip">еще ${hiddenTopicCount}</span>` : ""}
              </div>`
